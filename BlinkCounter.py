...
# Studymaterial: https://youtu.be/pcsHj09ioMg?list=PLBg7GSvtrU2OaYp2F-FqqZk0RUB4IUvvb
# Credits to my sister for the video.mp4 file
...
def drawing_output(frame,coordinates_left_eye,coordinates_right_eye, blink_counter):
    ...
    cv2.putText(output, "{}".format(blink_counter), (220,35), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (128,9,250), 2)
